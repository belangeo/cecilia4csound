...
class CECPreset(wx.Panel):
    ...
    def setLabel(self, label):
        if label in CeciliaLib.getPresets().keys():
    ...
    def orderingPresetNames(self):
        presets = CeciliaLib.getPresets().keys()
        presets.sort()
    ...
    def onDeletePreset(self):
        if CeciliaLib.getPresets().has_key(self.currentPreset):
    ...
    def onSavePreset(self):
        ...
        if newPreset in CeciliaLib.getPresets().keys():
